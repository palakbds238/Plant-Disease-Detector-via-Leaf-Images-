...
export const LeafIcon = ({ className }: { className?: string }) => (
  ...
  >
    ...
    <path d="M11 11a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2v-1a2 2 0 0 0-2-2h-2a2 2 0 0 0-2 2v1z" />
    <path d="M12 21a7 7 0 0 0 7-7v-6a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v2" />
  </svg>
);
...
export const ShieldCheckIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path><path d="m9 12 2 2 4-4"></path></svg>
);